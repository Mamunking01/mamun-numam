...
\033[1;37m------------------------------------------------
\033[1;37m Owner   :         MAMUN
\033[1;37m Facebook :         হাঁসি বিক্রেতা
\033[1;37m Github   :          Mamunking01
...
def sarfraz():   
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('xdg-open https://chat.whatsapp.com/H0fMPmaBmpdErI5lT5jc89')
        pass
    elif select =='F':
...
def p_dump():
    ...
    try:
        ...
        print(f"File Saved To  {filepath} ")
        print(47*'-')
        input("Press enter to back MAMUN Menu ")
        SSB(allkey)
    except Exception as e:
        print("Error : %s"%e) 
